...
const STATIC_VERSION = 'static-v11-20260606';  // bumped:r46 月台平行世界新建(demos/platform-run-parallel/)+ WebGPU bootstrap inline
// 升 RUNTIME_VERSION 重下 html / data.js / app.js(每次 source 變動)
const RUNTIME_VERSION = 'runtime-v11-20260606';  // bumped:r46 三線入口加平行世界卡 + parallel scene precache
