...
const RUNTIME_VERSION = 'runtime-v61-20260529';  // bumped: competition players 6+7 + lm402-twin postfx revival (full-res SSAO + DOF/bloom + adaptive quality + device-aware shadow)
