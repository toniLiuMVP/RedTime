...
const STATIC_VERSION = 'static-v90-20260726';  // bump: font subset re-cut(new glyph coverage)
// 升 RUNTIME_VERSION 重下 html / data.js / app.js(每次 source 變動)
const RUNTIME_VERSION = 'runtime-v432-20260817';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
