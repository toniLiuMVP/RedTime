...
const RUNTIME_VERSION = 'runtime-v81-20260603';  // bumped: site-wide copy polish (science-annotation accuracy + poetry, em-dash purge, sharper meta/onboarding/tier copy)
