...
const RUNTIME_VERSION = 'runtime-v392-20260721';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
