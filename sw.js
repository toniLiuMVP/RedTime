...
const STATIC_VERSION = 'static-v36-20260625';  // bump: heroine bangs lifted to reveal eyes + hair gloss overwrites cached original
// 升 RUNTIME_VERSION 重下 html / data.js / app.js(每次 source 變動)
const RUNTIME_VERSION = 'runtime-v196-20260625';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
