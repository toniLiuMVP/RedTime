...
const RUNTIME_VERSION = 'runtime-v41-20260527';  // bumped: consciousness mode polish — indefinite polling (was 30s, may miss cinematic gate hold) + badge uses <button> for a11y/keyboard + applyPreset bails on failure (no UI lie) + URL param case-insensitive
