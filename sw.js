...
const RUNTIME_VERSION = 'runtime-v176-20260624';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
