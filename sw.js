...
const RUNTIME_VERSION = 'runtime-v333-20260707';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
