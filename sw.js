...
const STATIC_VERSION = 'static-v21-20260625';  // bump: refined reveal characters GLB overwrites cached original (cache-first won't refetch without a key bump)
// 升 RUNTIME_VERSION 重下 html / data.js / app.js(每次 source 變動)
const RUNTIME_VERSION = 'runtime-v178-20260625';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
