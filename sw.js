...
const STATIC_VERSION = 'static-v78-20260703';  // bump: subset webfonts to the in-use glyph set
// 升 RUNTIME_VERSION 重下 html / data.js / app.js(每次 source 變動)
const RUNTIME_VERSION = 'runtime-v320-20260704';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
