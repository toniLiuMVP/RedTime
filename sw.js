...
const RUNTIME_VERSION = 'runtime-v83-20260603';  // bumped: remove the out-of-place 1163 memory vignette from the platform game (timeline-pause concern + thematic fit)
