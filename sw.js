...
const STATIC_VERSION = 'static-v30-20260625';  // bump: senior all-out facial detail pass overwrites cached original
// 升 RUNTIME_VERSION 重下 html / data.js / app.js(每次 source 變動)
const RUNTIME_VERSION = 'runtime-v189-20260625';   // bump every deploy that changes html/js/css; auto-reload then delivers the fix to clients still on the prior worker
