...
(function () {
  ...
  var CARDS = [
    { lines: ["把拔說過：", "愛因斯坦指出有一種世界，", "當離這個世界中心越近，時間就會過得越慢。", "", "阿姨，像不會被時間追上。"], auto: 0 },
    { kicker: "1994 · 阿姨高三的那個夏天", lines: ["禮堂喇叭放著畢業歌，", "第一個長音「傷離別～」在梁上盤旋。", "", "綠色布告欄前，她的名字被一封封情書寫滿，", "外圈密密畫著愛心。"], auto: 0 },
    { lines: ["廣播響起，點了她的座號：請立刻到訓導處。", "同學起鬨、偷笑、吹口哨。", "", "她心裡卻很安靜：", "關我什麼事？為什麼我要被約談？", "", "她伸出食指，把情書的紙角輕輕壓平，卻沒有撕下來。", "", "她不願讓喧鬧，替她下定義。"], auto: 0, big: "關我什麼事？" },
