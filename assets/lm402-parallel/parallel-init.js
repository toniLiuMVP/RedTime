/**
 * parallel-init.js — LM402 平行世界 WebGPU 初始化框架
 *
 * 提供 createParallelRenderer() 工廠函數,封裝 Three.js WebGPURenderer
 * 跟原 WebGLRenderer 的 API 差異(init async / outputColorSpace / toneMapping)。
 *
 * NOT YET WIRED — 獨立檔,目前不接 lm402-parallel.html(避免 break runtime)。
 * 將來切換 WebGLRenderer → WebGPURenderer 時 import 此檔。
 */
 ...
 *
 * 4. ⚠️ 所有 ShaderMaterial 失效 → 後續階段才修
 *
 * 5. ⚠️ postfx.js 整套失效 → 後續階段才修
 *
 * 6. WebGPU detection + fallback overlay 已偵測 + 引導,整合期 fallback 仍生效
 */
