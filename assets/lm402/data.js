export const STORAGE_KEYS = {
  ...
  lookSensitivity: "lm402_look_sensitivity_v2",
...
export const WORLD = {
  ...
  frontDoor: { z1: 520, z2: 584, center: { x: -210, y: 118, z: 552 } },
  backDoor: { z1: 734, z2: 798, center: { x: -210, y: 118, z: 766 } },
  plaque: { x: -248, y: 194, z: 520 },
  focusMark: { x: -244, y: 0, z: 766 },
  board: { x: 472, z1: 524, z2: 786, y1: 90, y2: 220 },
  frontWallWindows: [
    { x: 82, y1: 82, y2: 220, width: 144 },
    { x: 286, y1: 82, y2: 220, width: 168 },
  ],
  backWallWindows: [
    { x: 138, y1: 94, y2: 212, width: 154 },
    { x: 346, y1: 94, y2: 212, width: 168 },
  ],
  lightBeams: [
    { side: "front", x: 108, width: 156, reach: 248, alpha: 0.2 },
    { side: "front", x: 298, width: 184, reach: 286, alpha: 0.26 },
    { side: "rear", x: 142, width: 164, reach: 206, alpha: 0.12 },
    { side: "rear", x: 350, width: 188, reach: 236, alpha: 0.14 },
  ],
  desks: [
    { x: 18, z: 566 }, { x: 18, z: 650 }, { x: 18, z: 734 },
    { x: 122, z: 566 }, { x: 122, z: 650 }, { x: 122, z: 734 },
    { x: 226, z: 566 }, { x: 226, z: 650 }, { x: 226, z: 734 },
    { x: 330, z: 566 }, { x: 330, z: 650 }, { x: 330, z: 734 },
  ],
  notes: [
    { x: 252, y: 75, z: 654, label: "講義" },
    { x: 266, y: 75, z: 660, label: "白紙" },
  ],
  campusTrees: [
    { x: -1200, z: 220, scale: 2.88 },
    { x: -1330, z: 468, scale: 3.16 },
    { x: -1224, z: 806, scale: 3.08 },
    { x: -1348, z: 1148, scale: 3.28 },
    { x: -1218, z: 1498, scale: 3.12 },
    { x: -1360, z: 1868, scale: 3.32 },
    { x: -1238, z: 2220, scale: 2.94 },
  ],
};
...
export const INTRO_BEATS = [
  ...
  },
  {
    ...
    kicker: "利瑪竇",
    text: "利瑪竇四樓整層外廊和六間教室一起浮出來，LM402 在右邊第二間慢慢亮起。",
    ambience: "矮牆、柱列、門牌、外廊轉角和整層四樓的空氣一起靠近，像一段正在落地的電影軌道。",
  },
  {
    id: "sunlight_bloom",
    start: 4.2,
    ...
    kicker: "十一點",
    text: "十一點的陽光先灑在矮牆和樹冠上，再沿著教室門洞、前後窗帶和地板慢慢推進來。",
