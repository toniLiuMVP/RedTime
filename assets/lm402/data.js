...
export const PHASES = [
  ...
  },
  {
    ...
    index: "02",
    title: "前門來電",
    copy: "時空手錶顯示 11:00。鐘響了，學長從樓梯走過來，站在 LM402 前門外，打了那通電話。",
  },
  {
    id: "rear_wait",
    index: "03",
...
export const INTERACTIONS = {
  ...
  front_call: {
    ...
    speaker: "女兒",
    lines: [
      { speaker: "學長", text: "我站在前門，東張西望，卻沒看到妳。" },
      { speaker: "學長", text: "「妳在哪裡？」" },
      { speaker: "女兒", text: "這通電話一響，整條動線就會從前門折向後門。" },
      { speaker: "女兒", text: "等一下他真的轉身走過去時，所有還沒被說出口的喜歡，都會先藏進那幾步裡。" },
      { speaker: "女兒", text: "真正讓人心臟縮一下的，不只是他說了什麼，而是他還不知道，這一秒會把很多年後的所有人一起拉回來。" },
      { speaker: "女兒", text: "他現在只是往前門再多看一眼，可是你知道，真正刺進心裡的那一眼，還在後門等著。" },
      { speaker: "女兒", text: "這通電話並不喧鬧，反而像一根很細的線，先把走廊、教室、光和所有人的呼吸都悄悄拉成同一個節拍。" },
      { speaker: "女兒", text: "妳明明站得那麼遠，可是一想到他等一下真的會轉身走過去，心裡還是先一步亂了起來。" },
    ],
    choices: [
      {
        id: "front_call_phone",
  ...
  watch: {
    ...
    copy: [
      "這支手錶，是命運阿嬤送我的七歲生日禮物。",
      "它會自己對時，不管我飛到哪一條時間線，都會自動顯示正確的時間與日期。",
