...
function createHair(detail = 1, materials = {}, options = {}) {
  ...
  // 妹妹頭短瀏海：從髮帽自然延伸至齊眉處，終點不超過眉毛高度
  // hero 模式眉毛 y≈1.586 / 非 hero 模式眉毛 y≈1.592
  const bangs = hero
    ? [
        // 5 條短弧線，終點收在 y≈1.578–1.584（齊眉偏上），露出整張臉
        [[-0.052, 1.596, 0.072], [-0.048, 1.586, 0.098], [-0.044, 1.580, 0.108]],
        [[-0.026, 1.600, 0.082], [-0.022, 1.590, 0.106], [-0.018, 1.582, 0.116]],
        [[ 0.000, 1.602, 0.086], [ 0.000, 1.592, 0.110], [ 0.000, 1.584, 0.120]],
        [[ 0.026, 1.600, 0.082], [ 0.022, 1.590, 0.106], [ 0.018, 1.582, 0.116]],
        [[ 0.052, 1.596, 0.072], [ 0.048, 1.586, 0.098], [ 0.044, 1.580, 0.108]],
      ]
    : [
        // 5 條短弧線，終點收在 y≈1.585–1.591（齊眉），露出整張臉
        [[-0.066, 1.608, 0.108], [-0.060, 1.595, 0.132], [-0.054, 1.586, 0.144]],
        [[-0.034, 1.614, 0.122], [-0.030, 1.599, 0.144], [-0.026, 1.589, 0.152]],
        [[ 0.000, 1.616, 0.128], [ 0.000, 1.601, 0.148], [ 0.000, 1.591, 0.156]],
        [[ 0.034, 1.614, 0.122], [ 0.030, 1.599, 0.144], [ 0.026, 1.589, 0.152]],
        [[ 0.066, 1.608, 0.108], [ 0.060, 1.595, 0.132], [ 0.054, 1.586, 0.144]],
      ];
