...
// 讓沒讀過故事的人也懂：他為什麼跑、為什麼永遠不會放棄。融入 EP16「我現在都直接叫你一聲『爸』。」。
...
(function () {
  ...
  var CARDS = [
    ...
    { lines: ["在門快要關上的前兩秒，他趕上了。", "", "「我趕上了。」他一邊喘，一邊笑。"], auto: 0, big: "我趕上了", fx: "beat" },
    { lines: ["只要他還願意在月台上那樣用力地跑，", "我們之間，就還有一條拉得再長也不會斷的線。"], auto: 0, fx: "thread" },
